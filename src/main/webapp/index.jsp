...
<div class="top">
	<div class="top_center">
		<ul class="top_lr">
            ...
            <li><a href="register.html" style="color: orange;">免费注册</a></li>
        </ul>
        <ul class="top_bars">
            <li><a href="#" style="color: orange;">我的订单<span class="jt_down"></span></a>|</li>
            <li><a href="#" style="color: orange;">关注杰普<span class="jt_down"></span></a>|</li>
            <li><a href="#" style="color: orange;">网站导航<span class="jt_down"></span></a></li>
        </ul>
    </div>
</div>
 <!--头部-->
